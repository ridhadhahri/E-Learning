...
if (isset($_POST['login_ap'])) {
  ...
  $MM_redirectLoginSuccess = "espaceEns.php";
  $MM_redirectLoginFailed = "connexionENS.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_connexion, $connexion);
  
  $LoginRS__query=sprintf("SELECT login, pasword FROM enseignant WHERE login=%s AND pasword=%s",
		...
		<article class="article">
				...
				<ul class="ls">
				  <div id="leftcolumn_box01">
				    <div class="leftcolumn_box01_top"><center><h3>Connexion Enseignant</h3></center></div>
