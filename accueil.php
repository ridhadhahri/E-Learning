	...
	<div>
		...
		<div id="cc-tp-nav">		
			<div class="cc-tp-gutter">
				...
				<li id="cc-nav-view-644839652"><a href="#"><span>esapce personnel</span></a></li>
				              ...
				              <div id="leftcolumn_box2">
				                <ul class="ls">
				                  <div id="leftcolumn_box3">
				                    <div class="leftcolumn_box01_top"></div>
				                    <div class="leftcolumn_box01_bottom">
				                      <form action="<?php echo $loginFormAction1; ?>" method="post" id="connecte">
				                        <div class="form_row">
				                        <table width="100" height="20">
				                          <tr valign="baseline">
				                            <td>Login</td>
				                            <td><input class="inputfield" name="login_ap" type="text" id="login3"/>
				                              <input name="temp2" type="hidden" id="temp2" /></td>
			                              </tr>
				                          <div class="form_row">
				                            <tr>
				                              <td>Password</td>
				                              <td><p>
				                                <input class="inputfield" name="pasword_ap" type="password" id="pasword2"/>
				                                </p></td>
			                                </tr>
			                              </div>
				                          <tr valign="baseline">
				                            <td align="center"><div class="button1"  >
				                              <input class="button" type="submit" name="Submit2" onclick="" value="connexion" />
				                              </div></td>
			                              </tr>
			                            </table>
			                          </form>
