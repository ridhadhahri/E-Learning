...
$query_liste = "SELECT * FROM apprenant";
...
$query_liste = "SELECT apprenant.nom_ap ,apprenant.prenom_ap, apprenant.sexe_ap, apprenant.telephone_ap, apprenant.num_app, apprenant.login_ap, apprenant.Email_ap FROM apprenant where apprenant.activation_ap=1";
$liste=mysql_query($query_liste)or die(mysql_error());
$row_liste = mysql_fetch_assoc($liste);
$totalRows_liste = mysql_num_rows($liste);
if (isset($_POST['num_inscription'])) {
  $deleteSQL = sprintf("DELETE FROM apprenant WHERE id_membre=%s",
...
<div class="main">
 ...
 <?php do { ?>
            <tr bgcolor="#CCCCCC">
              <td height="25"style="text-align:center;width=50px;height:25px;background-color:#e6f8f4;"><?php echo $row_liste['login_ap']; ?></td>
              <td style="text-align:center;width=50px;height:25px;background-color:#e6f8f4;"><?php echo $row_liste['nom_ap']; ?></td>
              <td style="text-align:center;width=50px;height:25px;background-color:#e6f8f4;"><?php echo $row_liste['prenom_ap']; ?></td>
              <td style="text-align:center;width=50px;height:25px;background-color:#e6f8f4;"><?php echo $row_liste['num_app']; ?></td>
              <td style="text-align:center;width=50px;height:25px;background-color:#e6f8f4;"><?php echo $row_liste['Email_ap']; ?></td>
              <td style="text-align:center;width=50px;height:25px;background-color:#e6f8f4;"><?php echo $row_liste['telephone_ap']; ?></td>
              <td style="text-align:center;width=50px;height:25px;background-color:#e6f8f4;"><?php echo $row_liste['sexe_ap']; ?></td>
        ...
        <p><a href="rech_ap.php" class="retoure">      Retoure</a></p>
                  </div>
            <h1 class="style1">&nbsp;</h1>
